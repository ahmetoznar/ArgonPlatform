...
// MasterChef is the master of Argon. He can make Argon and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once ARGON is sufficiently
...
contract MasterChef is Ownable {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of ARGONs
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. ARGONs to distribute per block.
        uint256 lastRewardBlock;  // Last block number that ARGONs distribution occurs.
        uint256 accTargPerShare;   // Accumulated ARGONs per share, times 1e12. See below.
    ...
    // ARGON tokens created per block.
    ...
    // The block number when ARGON mining starts.
    ...
    // Update the given pool's ARGON allocation point and deposit fee. Can only be called by the owner.
    ...
    // View function to see pending ARGONs on frontend.
    ...
    // Deposit LP tokens to MasterChef for ARGON allocation.
    ...
    // Safe targ transfer function, just in case if rounding error causes pool to not have enough ARGONs.
